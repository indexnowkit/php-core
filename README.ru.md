...
| [`indexnowkit/console`](https://github.com/indexnowkit/php/tree/main/packages/console) | команды `check`, `config`, `submit`, `submit-<subject>`, `explain`, `key:generate` (классы `symfony/console`, их тела и определения); его требует каждый адаптер |

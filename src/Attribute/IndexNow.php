...
final readonly class IndexNow
{
     ...
     * @param string|Condition|FieldCondition|Closure|null   $when       condition: bool accessor (truthy), a Condition (`new Equals('status', 'published')`, your own), or a closure fn(object): bool (runtime-registered rules only); true -> false is sent as a deletion
